...
class User extends Entity implements AuthorizationIdentity, AuthenticationIdentity
{
    ...
    {
        $operadores = TableRegistry::getTableLocator()->get('Operadores');
        $operador = $operadores->find('all', ['conditions' => ['Operadores.user_id' => $this->id] ])->first();
        $this->operador_id = false;
        if (!empty($operador)) $this->operador_id = $operador->id;
