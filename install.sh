...
cd /var/www/html
git clone "https://github.com/rafaelcastrocouto/$project"
echo "repository cloned"

cd /var/www/html/$project
sudo chmod -R a+w /var/www/html/$project
sudo php /var/www/html/$project/src/Console/Installer.php
composer update
...
sudo cp /var/www/html/$project/config/.env.example /var/www/html/$project/config/.env
echo "export SECURITY_SALT="12345678901234567890123456789012" <<<<<<<< CHANGE THIS"
echo "export PASSWORD => "$password", <<<<<<<< CHANGE THIS"
echo -e "enter to proceed to nano"
read
sudo nano /var/www/html/$project/config/.env

# CREATE CONFIG app_local.php

sudo cp /var/www/html/$project/config/app_local.example.php /var/www/html/$project/config/app_local.php
echo "'database' => '"$database"', <<<<<<<< CHANGE THIS"
echo "'username' => '"$username"', <<<<<<<< CHANGE THIS"
echo -e "enter to proceed to nano"
read
sudo nano /var/www/html/$project/config/app_local.php
